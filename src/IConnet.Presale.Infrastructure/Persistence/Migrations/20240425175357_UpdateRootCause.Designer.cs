...
namespace IConnet.Presale.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240425175357_UpdateRootCause")]
    partial class UpdateRootCause
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ProsesApproval", "IConnet.Presale.Domain.Aggregates.Presales.WorkPaper.ProsesApproval#ApprovalProcess", b1 =>
                        {
                            ...
                            b1.Property<string>("DirectApproval")
                                .HasMaxLength(32)
                                .HasColumnType("varchar(32)")
                            ...
                            b1.Property<string>("SplitterGanti")
                                .HasColumnType("longtext")
            ...
            modelBuilder.Entity("IConnet.Presale.Domain.Entities.DirectApproval", b =>
                {
                    b.Property<Guid>("DirectApprovalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasKey("DirectApprovalId");

                    b.ToTable("dbo.direct_approval", (string)null);
                });
            ...
            modelBuilder.Entity("IConnet.Presale.Domain.Entities.RootCause", b =>
                {
                    ...
                    b.Property<bool>("IsOnVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
