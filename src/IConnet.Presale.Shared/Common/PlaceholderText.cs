namespace IConnet.Presale.Shared.Common;
...
public static class PlaceholderText
{
    ...
    public static readonly string AlamatEmail = "$ALAMAT_EMAIL";
    public static readonly string AlamatPemasangan = "$ALAMAT_PEMASANGAN";
